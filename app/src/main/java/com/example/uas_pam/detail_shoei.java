...
public class detail_shoei extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_shoei);

        recyclerView = findViewById(R.id.dtlshoei);

        /*Pembuatan PopUp loading*/
        progressDialog = new ProgressDialog(detail_shoei.this);
        ...
        helmAdapter.setDialog(new HelmAdapter.Dialog() {
            ...
            public void onClick(int pos) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(detail_shoei.this);
                ...
                dialog.setItems(dialogItem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        switch (i) {
                            /*Update Data*/
                            case 0:
                                Intent intent = new Intent(getApplicationContext(), order_shoei.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (!task.isSuccessful()){
                            Toast.makeText(detail_shoei.this, "Data Gagal Di hapus", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            Toast.makeText(detail_shoei.this, "Data Berhasil Di hapus", Toast.LENGTH_SHORT).show();
                        }
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(detail_shoei.this, "Data Gagal di Ambil", Toast.LENGTH_SHORT).show();
                        }
                        progressDialog.dismiss();
                    }
                });
